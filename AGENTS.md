...
- маршрут, экраны, компоненты и пользовательский копирайт в продукте по-прежнему опираются на `references/redesign-2026-04/preview.html`, `DESIGN_SPINE.md`, `UI_KIT_V0.md`, `SCREEN_ATLAS.md` и `COPY_RULES.md`;
- при противоречии приоритет у продуктовых доков и референса редизайна, а не у бренд-кита.
